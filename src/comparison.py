...
if __name__ == "__main__":
    ...
    if target in ["all", "single_simulation"]:
        ...
        for m_i in m_list:
            ...
            if os.path.exists(
                os.path.join(
                    results_dir, f"single_simulation/single_simulation_{m_i}.pkl"
                )
            ):
    ...
    if target in ["all", "complexity"]:
        ...
        for nsim in n_sim_list:
            ...
            if os.path.exists(
                os.path.join(results_dir, f"complexity/complexity_{int(nsim)}.pkl")
            ):
    ...
    if target in ["all", "benchmark"]:
        ...
        for nsim in n_sim_list:
            ...
            if os.path.exists(
                os.path.join(results_dir, f"benchmark/benchmark_{int(nsim)}.pkl")
            ):
            ...
            for i in range(n_repeats):
                ...
                subprocess.run(
                    [
                        ...
                        "1",
                        "--results_dir",
                        "results_benchmark_new_parallel/",
                        "--data_dir",
                        "data/benchmark_new_parallel/",
                        "--save_checkpoint",
                        "0",
                    ]
                )
            ...
            for i in range(n_repeats):
                ...
                subprocess.run(
                    [
                        ...
                        "1",
                        "--results_dir",
                        "results/benchmark_old_concat/",
                        "--data_dir",
                        "data/benchmark_old_concat/",
                        "--save_checkpoint",
                        "0",
                    ]
                )
            ...
            with open(
                os.path.join(results_dir, f"benchmark/benchmark_{nsim}.pkl"), "wb"
            ) as f:
                pickle.dump(
                    {
                        "nsim": nsim,
